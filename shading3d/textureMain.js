...
function drawCurrentShape () {
    ...
    var currentTexture = worldTexture;
    var useProcOrNot=0;
    if (curTexture=="myimage") currentTexture = myImageTexture;
    if(curTexture=="proc") useProcOrNot=1;
    ...
    gl.uniform1i(program.uUseProc, useProcOrNot);
...
function initProgram (vertexid, fragmentid) {
  ...
  program.uUseProc = gl.getUniformLocation(program, "useProc");
